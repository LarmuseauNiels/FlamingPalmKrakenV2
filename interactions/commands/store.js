...
module.exports = {
    ...
    async execute(interaction) {
        let embed = new EmbedBuilder()
            .setColor('#FD8612')
            .setTitle("Store")
            .setAuthor({name: interaction.user.username,iconURL: 'https://cdn.discordapp.com/avatars/' + interaction.user.id + '/' + interaction.user.avatar,url: 'https://flamingpalm.com'})
            .setDescription('Flamingpalm points store')
            //.setThumbnail('https://i.imgur.com/AfFp7pu.png')

            //.setImage('https://www.kenney.nl/assets/hexagon-kit/sample.png')
            .setTimestamp()
            .setFooter({text: 'Work in progress flamingpalm store', iconURL: 'https://flamingpalm.com/images/FlamingPalmLogoSmall.png'});
