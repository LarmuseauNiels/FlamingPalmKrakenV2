...
export function legacyEndPoints(app: any) {
  app.get("/activity", async function (req: any, res: any) {
  ...
  app.get("/activityFromDate/:date", async function (req: any, res: any) {
  ...
  app.get("/userActivityDate/:date", async function (req: any, res: any) {
    var date = req.params["date"];
    let results = await globalThis.client.prisma
  ...
  app.get("/channelActivity", async function (req: any, res: any) {
    let results = await globalThis.client.prisma
  ...
  app.get("/userActivity", async function (req: any, res: any) {
    let results = await globalThis.client.prisma
      .$queryRaw`SELECT Members.DisplayName as name, count(*) as y FROM VoiceConnected LEFT JOIN Members ON VoiceConnected.ID = Members.ID
  ...
  app.get("/userActivityAll", async function (req: any, res: any) {
    let results = await globalThis.client.prisma
      .$queryRaw`SELECT Members.DisplayName as name, count(*) as y FROM VoiceConnected LEFT JOIN Members ON VoiceConnected.ID = Members.ID
  ...
  app.get("/userOnlineTimes/:userId", async function (req: any, res: any) {
  ...
  app.get("/userInfo/:userId", async function (req: any, res: any) {
    var userId = req.params["userId"];
    let results = await globalThis.client.prisma
  ...
  app.get("/PossibleYears", async function (req: any, res: any) {
    let results = await globalThis.client.prisma
      .$queryRaw`select DISTINCT YEAR(timestamp) from VoiceConnected`;
    res.send(jsonify(results));
  });

  app.get("/YearActivity/:year", async function (req: any, res: any) {
  ...
  app.get("/events", async function (req: any, res: any) {
    if (globalThis.client.events == null) {
      const guild = await globalThis.client.guilds.fetch(config.guildId);
  ...
  app.get("/dailyAll", async function (req: any, res: any) {
    let results = await globalThis.client.prisma
